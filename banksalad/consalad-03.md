...
![1](/Users/jaeyeonling/workspace/jaeyeonling/conference/1.png) 

![2](/Users/jaeyeonling/workspace/jaeyeonling/conference/2.png)

![3](/Users/jaeyeonling/workspace/jaeyeonling/conference/3.png)

![4](/Users/jaeyeonling/workspace/jaeyeonling/conference/4.png)

## 키노트 연사

1. 콘샐러드를 시작한 이유

   - 컨퍼런스를 시작한 모티베이션은 외부 인력들과의 심도있는 대화를 하기 위해 시작

     (첫 컨퍼러스 때는 뱅크샐러드가 유명하지 않아 잘 안됐었다는 슬픈 전설이...)
...
1. ECMAScript ? TC39? Proposals?
   ...
   - 시간이 지남에 따라 브라우저 별로 자체적인 스크립트가 만들어짐

   - 브라우저 별로 따로 개발해야하니 너무 화나서 Netscape가 표준을 만들자고 함
...
3. 함께하는 개발 (식사)
   ...
   * 협업의 장인 Github을 잘쓰는 것이 가장 중요
     ...
     * 건강한 코드리뷰 문화를 위해 규칙을 정해 관리
       * 코드리뷰는 500줄 이내로 (500줄 이내가 좋은건 과학적으로 증명된거임! 아무튼 된거임!)
...
4. Q/A
   ...
   * 개발자들 끼리 Git으로 이슈를 관리하면 QA 팀이나 기획팀 등 다른 팀에선 어떻게 하나요?
...
느낀 점은 뱅크샐러드는 개발자의 성장을 굉장히 신경쓰는 회사인거 같고, 건물도 좋고 전부 너무 좋아 보인다.
